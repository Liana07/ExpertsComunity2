...
include_once 'C:\xampp\htdocs\ExpertsComunity\auth\parsProfile.php';
?>
...
<div class="container">
    <div >
        ...
        <section class="col col-lg-7">
            <div class="row col-lg-5" style="margin-bottom: 10px;">
                <img src="<?php if(isset($profile_picture)) echo $profile_picture; ?>" class="img img-rounded" width="220" height="200"/>
            </div>
