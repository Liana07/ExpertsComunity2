                ...
                if ($deactivateQuery->rowCount() === 1){
                    ...
                    if ($insertRecord->rowCount() === 1){
                        ...
                        <body style="background-color:#CCCCCC; color:#000; font-family: Arial, 
                            ...
                            <h2>User Authentication:Exparts Comunity</h2>
                            ...
                            <p><a href="http://localhost/ExpertsComunity/auth/login.php">Sign In</a></p>
                            <p><strong>&copy;2018 WebDev</strong></p>
                        </body>
                        </html>';

                        $mail->addAddress($email, $username);
                        $mail->Subject = "Message from WebDev: Account Deactivated";
                        $mail->Body = $mail_body;
