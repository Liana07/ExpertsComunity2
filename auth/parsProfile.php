...
include_once 'C:\xampp\htdocs\ExpertsComunity\auth\resources\utilities.php';
    ...
    if(validate_token($_POST['token'])){
        ...
        if(empty($form_errors)){
            try{
                ...
                swal({title:\"Updated!\", text:\"Profile Update Successfully.\", type:\"success\"});</script>";
                }else{
                    $result = "<script type=\"text/javascript\">
                swal({title:\"Nothing Happened\", text:\"You have not made any changes.\"});</script>";
                }
